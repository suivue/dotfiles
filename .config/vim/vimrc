...
if filereadable($HOME . "/.vim/plugins/plugin_globals.vim")
  source $HOME/.vim/plugins/plugin_globals.vim
endif

" --- Source any other plugin file(s) ---
if filereadable($HOME . "/.vim/plugins/plugin_coc.vim")
  source $HOME/.vim/plugins/plugin_coc.vim
endif
